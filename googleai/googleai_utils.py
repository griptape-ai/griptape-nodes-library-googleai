...
class GoogleAuthHelper:
    ...
    def get_credentials_and_project(
        ...
        workload_identity_config = secrets_manager.get_secret(
            GoogleAuthHelper.WORKLOAD_IDENTITY_CONFIG_PATH, should_error_on_not_found=False
        )
        service_account_file = secrets_manager.get_secret(
            GoogleAuthHelper.SERVICE_ACCOUNT_FILE_PATH, should_error_on_not_found=False
        )
        ...
        credentials_json = secrets_manager.get_secret(
            GoogleAuthHelper.CREDENTIALS_JSON, should_error_on_not_found=False
        )
